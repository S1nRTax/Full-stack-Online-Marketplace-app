...
namespace Server.Migrations
{
    ...
    [Migration("20241225033336_PostModelWithOneToManyRelationWithVendors")]
    partial class PostModelWithOneToManyRelationWithVendors
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Models.PostModel", b =>
                {
                    ...
                    b.Property<double>("PostPriceTag")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Server.Models.AccessToken", b =>
                {
                    b.HasOne("Server.Models.User", "User")
                        .WithOne("AccessToken")
                        .HasForeignKey("Server.Models.AccessToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
